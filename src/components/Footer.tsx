        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
              <Link
                href="/"
                className="transition-colors hover:opacity-80 font-medium whitespace-nowrap"
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://github.com/islanddao"
                target="_blank"
                rel="noopener noreferrer"
                className="transition-opacity hover:opacity-70"
                style={{ color: 'var(--color-text-secondary)' }}
              ...
              <a
                href="https://t.me/c/2057529589/1"
                target="_blank"
                rel="noopener noreferrer"
                className="transition-opacity hover:opacity-70"
                style={{ color: 'var(--color-text-secondary)' }}
          ...
          <div
            className="flex flex-col-reverse md:flex-row justify-between items-center gap-4 text-sm"
            style={{ color: 'var(--color-text-secondary)' }}
          >
