...
export const metadata: Metadata = {
  ...
  description: "IslandDAO is a Solana network state bringing together Web3 builders through global coworking events, on-chain governance, and citizen collaboration.",
  keywords: [
    "IslandDAO",
    "Solana",
    "Network State",
  ...
  openGraph: {
    ...
    description: "Join a global community of Web3 builders. Experience month-long coworking events, participate in on-chain governance, and help shape the future of decentralized organizations.",
  },
  twitter: {
